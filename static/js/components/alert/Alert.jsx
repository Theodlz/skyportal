                ...
                >
                  ...
                  {(savedSource || loadedSourceId === objectId) && (
                    ...
                    >
                      ...
                      >
                        <TextField
                          label="Candid (optional)"
                          size="small"
                          value={cutoutCandid}
                          onChange={(e) => setCutoutCandid(e.target.value)}
                          style={{ width: "10rem" }}
                          inputProps={{ inputMode: "numeric" }}
                        />
                        <FormControl size="small" style={{ width: "9rem" }}>
                          <InputLabel>Which alert</InputLabel>
                          <Select
                            label="Which alert"
                            value={cutoutWhich}
                            onChange={(e) => setCutoutWhich(e.target.value)}
                            disabled={!!cutoutCandid}
                          >
                            <MenuItem value="last">Last</MenuItem>
                            <MenuItem value="first">First</MenuItem>
                            <MenuItem value="brightest">Brightest</MenuItem>
                            <MenuItem value="faintest">Faintest</MenuItem>
                          </Select>
                        </FormControl>
                        <Button
                          size="small"
                        ...
                        >
                          {cutoutSaving ? "Saving…" : "Save cutouts"}
                        </Button>
                      </div>
                    </div>
                  )}
